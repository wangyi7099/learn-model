...
for idx, row in df[:10000].iterrows():
    source.append(tokenize(str(row['zh'])))
    target.append(str(row['en']).split(' '))
...
class DecoderBlock(nn.Module):
    ...
    def __init__(self, key_size, query_size, value_size,
                 num_hidden, normal_shape, ffn_input, ffn_hidden,
...
if __name__ == '__main__':
    ...
    d2l.train_seq2seq(net, train_iter, lr, num_epochs,
                      tgt_vocab, device, False)
