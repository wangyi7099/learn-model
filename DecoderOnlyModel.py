...
class DecoderOnlyModelConfig(PretrainedConfig):
    def __init__(self, vocab_size, num_hiddens, norm_shape, ffn_num_input, ffn_num_hiddens, num_heads, num_layers, dropout, rms_norm_eps, max_position_embeddings=32768, num_key_value_heads=32, sliding_window=4096, layer_types=None, max_window_layers=28,  attention_dropout=0.0, **kwargs):
